...
from lionpride.lndl.ast import Lact, Lvar, OutBlock, Program, RLvar
from lionpride.lndl.parser import parse_value
...
class TestParseLact:
    ...
    def test_parse_lact_reserved_keyword_warning(self):
        ...
        from lionpride.lndl.parser import _warned_action_names
